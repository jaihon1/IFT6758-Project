...
a goal in function of shot distance. The highest percentage is 24.49 for the shortest shot distance
interval (1 feet to 5.8 feets), which is logical because it is very close to the net.
Then at 60 feets, it reaches a percentage of 2.48, and then the percentage stays between 2 and 6
until the distance of 98 feets.

Then for the 2020 season(third graph of the figure), the figure below describes the chance of scoring a goal in
