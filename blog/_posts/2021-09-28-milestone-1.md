...
![Top 20 Goalies 2017](/public/milestone1/top-goalies-nomask.png)
...
![Top 20 Goalies 2017](/public/milestone1/top-goalies-mask.png)
...
## Data Acquisition
*The code for this part can be found at /project/ift6758/data/GamesInfo.py*
...
The interactive debugging tool can be found in project/notebooks/Interactive debugging tool.ipynb.

Here are pictures of it:
![bonus_applet.png](/public/milestone1/bonus_applet.png)
![bonus_applet_json.png](/public/milestone1/bonus_applet_json.png)
...
## Tidy Data
*The code for this part can be found at /project/ift6758/data/driver.py and /project/ift6758/data/EventGenerator.py*
...
![Dataframe all seasons](/public/milestone1/df_screenshot.png)
...
*The code for this part can be found at /project/ift6758/data/Visualisation.py*
...
15.2%. The percentage was computed by doing (# goals/ (# shots + # goals)) since goals are also shots, just succesful one.

![img_2.png](/public/milestone1/img_2.png)
...
![img_1.png](/public/milestone1/img_1.png)

![img_3.png](/public/milestone1/img_3.png)
...
![img_4.png](/public/milestone1/img_4.png)
...
Quite strikingly, there is the type of shot Wrap-around, between 53.2-60.7 feet, that displays 100 % of shot efficiency. This is obviously cause by the fact that a very few number of shot events were recorded for this specific condition, and all of them were shots that became goals, thus inflating the actual shot efficiency. With more events of this specific type, as N increases, the shot efficiency would be  more representative.

## Advanced Visualizations: Shot Maps
*The code for this part can be found at /project/notebooks/Advanced Visualisation.ipynb*
...
<figure style="display: block;margin-left: auto; margin-right: auto;width:50%;height:50%;">
    <img src="/public/milestone1/COL-standings-2016.png" alt="Colorado Avalanche 2016 standings">
...
<figure style="display: block;margin-left: auto; margin-right: auto;width:50%;height:50%;">
    <img src="/public/milestone1/COL-standings-2020.png" alt="Colorado Avalanche 2020 standings">
